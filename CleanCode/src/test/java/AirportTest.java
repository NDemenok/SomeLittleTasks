...
public class AirportTest {
	...
	public void testGetTransportMilitaryPlanes() {
		...
		Assert.assertFalse(transportMilitaryPlanes.isEmpty(), "Has no transport military plane!");
	}
	...
	public void testSortByMaxLoadCapacity() {
		...
		Assert.assertFalse(nextPlaneMaxLoadCapacityIsHigherThanCurrent);
	}
	...
	public void testHasAtLeastOneBomberInMilitaryPlanes() {
		...
		Assert.assertFalse(bomberMilitaryPlanes.isEmpty(), "Has no bomber!");
	}
	...
	public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified() {
		...
		boolean hasUnclassifiedPlanes = experimentalPlanes.get(0)
				.getClassificationLevel() == ClassificationLevel.UNCLASSIFIED;
